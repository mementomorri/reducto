...
> **Implementation (v1.0):** Python 3.14+ CLI (`pip install reducto`). Single Python package; analyzes and refactors **Python (`.py`) code only**. User guide: [README.md](README.md).
>
