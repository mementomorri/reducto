...
> **Implementation (v1.0):** Python 3.14+ CLI (`pip install reducto`). In-process `Workspace` replaces the former Go MCP server and Python sidecar. See [ARCHITECTURE.md](ARCHITECTURE.md).
