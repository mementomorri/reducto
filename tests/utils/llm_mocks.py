...
class MockLLMResponse:
    ...
    def __init__(self, fixture_path: str, fixtures_dir: Path | None = None):
...
class MockLLMResponses:
    ...
    def __init__(self, responses: list, fixtures_dir: Path | None = None):
        self.responses = responses
        self.call_index = 0
        self.fixtures_dir = (
            fixtures_dir or Path(__file__).parent.parent / "fixtures" / "llm_responses"
        )
        self.active = False
